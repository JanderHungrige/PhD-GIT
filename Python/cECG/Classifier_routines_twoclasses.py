...
#### TRAIN CLASSIFIER
    ...
    #THE SVM
        if (classweight==1)and (weighting_each_sample==0):# and (Selected_test!=7) :# as baby 7 does not have two classes, it is not unbalnced
             clf = svm.SVC(kernel='rbf', class_weight=cWdict, probability=True, random_state=42)
        ...
        elif(classweight==1)  and (weighting_each_sample==1): #and (Selected_test!=7): 
