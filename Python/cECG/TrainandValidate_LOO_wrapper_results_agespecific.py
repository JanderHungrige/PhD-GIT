# -*- coding: utf-8 -*-
"""
Created on Wed Dec 21 09:48:28 2016
...
for i in range(1, len(lst)+1):
    ...
    combs.extend(els)  
combs_short=[combs for combs in combs if len(combs) <= 7] #due to computation time we stop with 5 Features per set.

### load result from the wrapper
#AUCs=load ('C:/Users/310122653/Documents/PhD/InnerSense Data/Matlab/saves/python/outfile_7_latest_incl_age.npy')
...
#AUCs=load("D:/Dropbox/PHD/python/Outfiles_after_Leuven/outfile_5_incl_age_afterLeuven_5min.npy")
#combs_short=load("D:/Dropbox/PHD/python/Outfiles_after_Leuven/combs_short_5_incle_age_afterLeuven_5min.npy")

AUCs=load("C://Users//310122653//Dropbox//PHD//python//Inner Sence//outfiles/outfile_5_incl_age_afterLeuven_5min.npy")
combs_short=load("C://Users//310122653//Dropbox//PHD//python//Inner Sence//outfiles/combs_short_5_incle_age_afterLeuven_5min.npy")
...
#THE SVM
    if (classweight==1):# as baby 7 does not have two classes, it is not unbalnced
        ...
        clf = svm.SVC(kernel='rbf',gamma=0.2, C=0.5, probability=True, random_state=42)
...
plt.rcParams.update({'font.size': 20})
if savefig==1:
    plt.savefig('C:/Users/310122653/Documents/PhD/Article 1/FIgures/Autosave/ROC_and_meanROC_with_age  0.87.svg',format='svg', dpi=600)
    plt.savefig('C:/Users/310122653/Documents/PhD/Article 1/FIgures/Autosave/ROC_and_meanROC_with_age  0.87.eps', format='eps', dpi=1000)
    plt.savefig('C:/Users/310122653/Documents/PhD/Article 1/FIgures/Autosave/ROC_and_meanROC_with_age  0.87.tiff', format='tiff', dpi=600)     
    manager = plt.get_current_fig_manager() #maximize window size
    manager.window.showMaximized()
...
for sets in range(9):
    ...
    for feat in range(len(selecetedF)):
        print('the %dth set, top features are %s' %(sets+2, features_dict[selecetedF[feat]]))
