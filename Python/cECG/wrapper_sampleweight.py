...
from Loading_5min_mat_files import AnnotMatrix_each_patient, FeatureMatrix_each_patient, sampleWeights, Class_dict, features_dict, features_indx
...
weighting_each_sample=1 #if each sample is weighted with the observer insecurity. Unsure is 0.5 while sure is 1. This is multiplied with C for each sample
...
#### TRAIN CLASSIFIER
    ...
    #THE SVM
        if (classweight==1) and (Selected_test!=7) and (weighting_each_sample==0):# as baby 7 does not have two classes, it is not unbalnced
        ...
        elif(classweight==1) and (Selected_test!=7) and (weighting_each_sample==1):
...
save('C://Users//C3PO//Documents//PhD//Matrizen//outfile_5_nachLeuven_5min_sampleweight', collected_mean_auc)
save('C://Users//C3PO//Documents//PhD//Matrizen//combs_short_5_nachLeuven_5min_sampleweight', combs_short)
#import scipy.io as sio
#sio.savemat('C://Users//C3PO//Documents//PhD//Matrizen//outfile', collected_mean_auc)
print("FINISHED")
print("--- %s seconds ---" % (time.time() - start_time))

#console1 ist 5 features normal, console 2 ist 7 features mit age console 3 ist 7 features normal